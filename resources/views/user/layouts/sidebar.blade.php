...
<aside class="sidebar col-xl-3">
    <a href="{{ route('profil') }}" class="sidebar-logo">
        <div class="d-flex justify-content-start align-items-center center">
            <img class="img-fluid mb-auto" src="{{ asset('assets/img/component/profile.png') }}" alt="" width="50px">
            <ul class="mx-auto my-auto">
                ...
                ?>
                <li><h3 class='fs-5 fw-bold'>{{$name}}</h3></li>
                <li><p style="font-size:1.1rem;">{{ $status }}</p></li>
            </ul>
        </div>
        <button id="toggle-navbar" onclick="toggleNavbar()">
            <i class="fas fa-times-circle" style="font-size: 2rem; color:#22A168;"></i>
        </button>
    </a>

    <img width="300px" class="justify-content-center mb-4 mt-3 mx-auto" src="{{ asset('assets/img/component/ewallet.png') }}" alt="">
    ...
    <a href="/checkout" class="sidebar-item {{ Request::is('checkout') ? 'active' : ''}}" onclick="toggleActive(this)">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="/event" class="sidebar-item {{ Request::is('event') ? 'active' : ''}}" onclick="toggleActive(this)">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="/store" class="sidebar-item {{ Request::is('store') ? 'active' : ''}}" onclick="toggleActive(this)">
    ...
    <h5 class="sidebar-title2">Activity</h5>
    <a href="/history" class="sidebar-item {{ Request::is('history') ? 'active' : ''}}" onclick="toggleActive(this)">
    ...
    <a href="/profil" class="sidebar-item {{ Request::is('profil') ? 'active' : ''}}" onclick="toggleActive(this)">
    ...
    <a style="cursor: pointer" data-target="#logoutModals" id="logouts" data-toggle="modal" class="sidebar-item">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16 17L21 12L16 7" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M21 12H9" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H9" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
